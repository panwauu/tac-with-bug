<template>
  <div
    :class="`cardDeck ${miscState.players.length === 6 && positionStyles.turned === true ? 'cardDeckWidthTurned' : 'cardDeckWidth'}`"
    :style="positionStyles.stylePositionDeck?.[rotateIndex(miscState.deckInfo[0])]"
  >
    <img
