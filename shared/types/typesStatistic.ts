...
export interface peopleOjectType { // playedTogether - Won together - playedAgainst - won against
...
export interface gameStatisticCardsType { // Total played / actually used / traded to Partner
