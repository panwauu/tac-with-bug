...
test('createCardWithMove - test Easy Number (2-6,9-12)', () => {
  ...
  expect(createCardWithMove('2', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: '2',
    possible: true,
    ballActions: { 0: [ballStart(0, balls) + 2], 2: [ballStart(2, balls) + 2], 3: [ballStart(3, balls) + 2] },
    textAction: '',
  })
  expect(createCardWithMove('2', balls, 2, 2, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: '2',
    possible: true,
    ballActions: { 0: [ballStart(0, balls) + 2], 2: [ballStart(2, balls) + 2], 3: [ballStart(3, balls) + 2] },
    textAction: '',
  ...
  expect(createCardWithMove('10', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: '10',
    possible: true,
    ballActions: { 3: [ballStart(3, balls) + 12] },
    textAction: '',
  })
  expect(createCardWithMove('10', balls, 2, 2, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: '10',
    possible: true,
    ballActions: { 3: [ballStart(3, balls) + 12] },
    textAction: '',
  ...
  expect(createCardWithMove('3', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: '3',
    possible: true,
    ballActions: { 0: [ballGoal(0, balls) + 1, ballStart(0, balls) + 2] },
    textAction: '',
  })
})
...
test('createCardWithMove - test 8', () => {
  ...
  expect(createCardWithMove('8', balls, 1, 1, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: '8',
    possible: true,
    ballActions: { 4: [ballStart(0, balls) + 9] },
    textAction: 'aussetzen',
  })
  ...
  cards.players[2] = []
  expect(createCardWithMove('8', balls, 1, 1, initializeTeams(4, 2), cards, false, null)).toEqual({
    title: '8',
    possible: true,
    ballActions: { 4: [ballStart(0, balls) + 9] },
    textAction: '',
...
test('createCardWithMove - test 1 and 13', () => {
  const balls = cloneDeep(ballsSample)
  expect(createCardWithMove('1', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: '1',
    possible: true,
    ballActions: { 0: [ballStart(0, balls)], 1: [ballStart(0, balls)], 2: [ballStart(0, balls)], 3: [ballStart(0, balls)] },
    textAction: '',
  })
  expect(createCardWithMove('13', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: '13',
    possible: true,
    ballActions: { 0: [ballStart(0, balls)], 1: [ballStart(0, balls)], 2: [ballStart(0, balls)], 3: [ballStart(0, balls)] },
    textAction: '',
  ...
  expect(createCardWithMove('1', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: '1',
    possible: true,
    ballActions: { 0: [ballStart(0, balls) + 1], 1: [ballStart(0, balls)], 2: [ballStart(0, balls)], 3: [ballStart(0, balls)] },
    textAction: '',
  })
  expect(createCardWithMove('13', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: '13',
    possible: true,
    ballActions: { 0: [ballStart(0, balls) + 13], 1: [ballStart(0, balls)], 2: [ballStart(0, balls)], 3: [ballStart(0, balls)] },
    textAction: '',
  })
  ...
  expect(createCardWithMove('1', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: '1',
    possible: true,
    ballActions: { 1: [ballStart(0, balls)], 0: [ballStart(0, balls) + 1], 2: [ballStart(0, balls)], 3: [ballStart(0, balls)] },
    textAction: '',
  })
  expect(createCardWithMove('13', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: '13',
    possible: true,
    ballActions: { 1: [ballStart(0, balls)], 2: [ballStart(0, balls)], 3: [ballStart(0, balls)] },
    textAction: '',
  })
})
...
test('createCardWithMove - test 1 for 6 players', () => {
  ...
  expect(createCardWithMove('1', balls, 0, 0, initializeTeams(6, 2), cardsSample, false, null)).toEqual({
    title: '1',
    possible: true,
    ballActions: {
      8: [ballStart(8, balls)],
      9: [ballStart(8, balls)],
      10: [ballStart(8, balls)],
      11: [ballStart(8, balls)],
      16: [ballStart(16, balls)],
      17: [ballStart(16, balls)],
      18: [ballStart(16, balls)],
      19: [ballStart(16, balls)],
    },
    textAction: '',
  })
  expect(createCardWithMove('1', balls, 0, 0, initializeTeams(6, 3), cardsSample, false, null)).toEqual({
    title: '1',
    possible: true,
    ballActions: { 12: [ballStart(12, balls)], 13: [ballStart(12, balls)], 14: [ballStart(12, balls)], 15: [ballStart(12, balls)] },
    textAction: '',
  })
})
...
test('createCardWithMove - test -4', () => {
  ...
  balls[0].position = ballStart(0, balls)
  expect(createCardWithMove('4', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: '4',
    possible: true,
    ballActions: { 0: [ballGoal(0, balls) - 4] },
    textAction: '',
  })
  ...
  expect(createCardWithMove('4', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: '4',
    possible: true,
    ballActions: { 0: [ballGoal(0, balls) + 3, ballGoal(0, balls) - 4] },
    textAction: '',
  })
  ...
  expect(createCardWithMove('4', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: '4',
    possible: true,
    ballActions: { 0: [ballGoal(0, balls) + 2, ballGoal(0, balls) - 3] },
    textAction: '',
  })
  ...
  expect(createCardWithMove('4', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: '4',
    possible: true,
    ballActions: { 0: [ballGoal(0, balls) - 3] },
    textAction: '',
  })
  ...
  expect(createCardWithMove('4', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: '4',
    possible: true,
    ballActions: { 0: [ballGoal(0, balls) + 2, ballGoal(0, balls) - 3], 1: [ballStart(0, balls) + 1] },
    textAction: '',
  })
})
...
test('createCardWithMove - test trickser', () => {
  const balls = cloneDeep(ballsSample)
  expect(createCardWithMove('trickser', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: 'trickser',
    possible: false,
    ballActions: {},
    textAction: '',
  ...
  expect(createCardWithMove('trickser', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: 'trickser',
    possible: true,
    ballActions: { 0: [ballStart(4, balls), ballStart(8, balls)], 4: [ballStart(0, balls), ballStart(8, balls)], 8: [ballStart(0, balls), ballStart(4, balls)] },
    textAction: '',
  })
})
...
test('createCardWithMove - test tac: Never Called with tac -> Error', () => {
  const balls = cloneDeep(ballsSample)
  expect(() => {
    createCardWithMove('tac', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)
  }).toThrow('cannot createCardWithMove with tac Card')
})

test('createCardWithMove - test engel', () => {
  const balls = cloneDeep(ballsSample)
  expect(createCardWithMove('engel', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: 'engel',
    possible: true,
    ballActions: { 4: [ballStart(4, balls)], 5: [ballStart(4, balls)], 6: [ballStart(4, balls)], 7: [ballStart(4, balls)] },
    textAction: '',
  })
  for (let i = 1; i < 4; i++) {
  ...
  expect(createCardWithMove('engel', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: 'engel',
    possible: true,
    ballActions: { 4: [ballStart(4, balls) + 1, ballStart(4, balls) + 13] },
    textAction: '',
  })
  ...
  expect(createCardWithMove('engel', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: 'engel',
    possible: true,
    ballActions: { 4: [ballStart(4, balls) + 1] },
    textAction: '',
  })
...
test('createCardWithMove - test engel 4 every Player', () => {
  ...
  expect(createCardWithMove('engel', balls, 1, 1, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: 'engel',
    possible: true,
    ballActions: { 8: [ballStart(8, balls)], 9: [ballStart(8, balls)], 10: [ballStart(8, balls)], 11: [ballStart(8, balls)] },
    textAction: '',
  })
  expect(createCardWithMove('engel', balls, 2, 2, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: 'engel',
    possible: true,
    ballActions: { 12: [ballStart(12, balls)], 13: [ballStart(12, balls)], 14: [ballStart(12, balls)], 15: [ballStart(12, balls)] },
    textAction: '',
  })
  expect(createCardWithMove('engel', balls, 3, 3, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: 'engel',
    possible: true,
    ballActions: { 0: [ballStart(0, balls)], 1: [ballStart(0, balls)], 2: [ballStart(0, balls)], 3: [ballStart(0, balls)] },
    textAction: '',
  ...
  expect(createCardWithMove('engel', balls, 0, 0, initializeTeams(6, 2), cardsSample, false, null)).toEqual({
    title: 'engel',
    possible: true,
    ballActions: { 4: [ballStart(4, balls)], 5: [ballStart(4, balls)], 6: [ballStart(4, balls)], 7: [ballStart(4, balls)] },
    textAction: '',
  })
  expect(createCardWithMove('engel', balls, 1, 1, initializeTeams(6, 2), cardsSample, false, null)).toEqual({
    title: 'engel',
    possible: true,
    ballActions: { 8: [ballStart(8, balls)], 9: [ballStart(8, balls)], 10: [ballStart(8, balls)], 11: [ballStart(8, balls)] },
    textAction: '',
  })
  expect(createCardWithMove('engel', balls, 2, 2, initializeTeams(6, 2), cardsSample, false, null)).toEqual({
    title: 'engel',
    possible: true,
    ballActions: { 12: [ballStart(12, balls)], 13: [ballStart(12, balls)], 14: [ballStart(12, balls)], 15: [ballStart(12, balls)] },
    textAction: '',
  })
  expect(createCardWithMove('engel', balls, 3, 3, initializeTeams(6, 2), cardsSample, false, null)).toEqual({
    title: 'engel',
    possible: true,
    ballActions: { 16: [ballStart(16, balls)], 17: [ballStart(16, balls)], 18: [ballStart(16, balls)], 19: [ballStart(16, balls)] },
    textAction: '',
  })
  expect(createCardWithMove('engel', balls, 4, 4, initializeTeams(6, 2), cardsSample, false, null)).toEqual({
    title: 'engel',
    possible: true,
    ballActions: { 20: [ballStart(20, balls)], 21: [ballStart(20, balls)], 22: [ballStart(20, balls)], 23: [ballStart(20, balls)] },
    textAction: '',
  })
  expect(createCardWithMove('engel', balls, 5, 5, initializeTeams(6, 2), cardsSample, false, null)).toEqual({
    title: 'engel',
    possible: true,
    ballActions: { 0: [ballStart(0, balls)], 1: [ballStart(0, balls)], 2: [ballStart(0, balls)], 3: [ballStart(0, balls)] },
    textAction: '',
...
test('createCardWithMove - test 7', () => {
  ...
  expect(createCardWithMove('7', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: '7',
    possible: true,
    ballActions: { 0: [17, 18, 19, 20, 21, 22, 23] },
    textAction: '',
  })
  ...
  expect(createCardWithMove('7', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: '7',
    possible: true,
    ballActions: { 0: [ballGoal(0, balls), 17, ballGoal(0, balls) + 1, 18, ballGoal(0, balls) + 2, 19, ballGoal(0, balls) + 3, 20, 21, 22, 23] },
    textAction: '',
  })
  expect(createCardWithMove('7-2', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: '7-2',
    possible: true,
    ballActions: { 0: [ballGoal(0, balls), 17, ballGoal(0, balls) + 1, 18] },
    textAction: '',
  })
  ...
  expect(createCardWithMove('7', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: '7',
    possible: true,
    ballActions: { 0: [17, 18, 19, 20, 21, 22, 23], 1: [ballGoal(0, balls) + 1, ballGoal(0, balls) + 2, ballGoal(0, balls) + 3] },
    textAction: '',
  })
  expect(createCardWithMove('7-4', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: '7-4',
    possible: true,
    ballActions: { 0: [17, 18, 19, 20], 1: [ballGoal(0, balls) + 1, ballGoal(0, balls) + 2, ballGoal(0, balls) + 3] },
    textAction: '',
  })
  ...
  expect(createCardWithMove('7', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: '7',
    possible: true,
    ballActions: { 0: [ballGoal(0, balls), 17, ballGoal(0, balls) + 1, 18, 19, 20, 21, 22, 23], 1: [83, 81, 80], 2: [19, 20, 21, 22, 23, 24, 25] },
    textAction: '',
  })
  expect(createCardWithMove('7-2', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: '7-2',
    possible: true,
    ballActions: { 0: [ballGoal(0, balls), 17, ballGoal(0, balls) + 1, 18], 1: [83, 81, 80], 2: [19, 20] },
    textAction: '',
  })
})
...
test('createCardWithMove - test 7 in goal', () => {
  ...
  expect(createCardWithMove('7', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: '7',
    possible: true,
    ballActions: { 0: [ballGoal(0, balls) + 1, ballGoal(0, balls) + 2, ballGoal(0, balls) + 3] },
    textAction: '',
  })
  expect(createCardWithMove('7-3', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: '7-3',
    possible: true,
    ballActions: { 0: [ballGoal(0, balls) + 1, ballGoal(0, balls) + 2, ballGoal(0, balls) + 3] },
    textAction: '',
  })
  expect(createCardWithMove('7-1', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: '7-1',
    possible: true,
    ballActions: { 0: [ballGoal(0, balls) + 1] },
    textAction: '',
  })
  ...
  expect(createCardWithMove('7', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: '7',
    possible: true,
    ballActions: { 0: [ballGoal(0, balls) + 2, ballGoal(0, balls), ballGoal(0, balls) + 3] },
    textAction: '',
  })
  expect(createCardWithMove('7-3', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: '7-3',
  ...
  expect(createCardWithMove('7-1', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: '7-1',
    possible: true,
    ballActions: { 0: [ballGoal(0, balls) + 2, ballGoal(0, balls)] },
    textAction: '',
  })
  ...
  expect(createCardWithMove('7', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: '7',
    possible: true,
    ballActions: { 0: [ballGoal(0, balls) + 2, ballGoal(0, balls) + 1, ballGoal(0, balls)] },
    textAction: '',
  })
  expect(createCardWithMove('7-3', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: '7-3',
  ...
  expect(createCardWithMove('7-1', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: '7-1',
    possible: true,
    ballActions: { 0: [ballGoal(0, balls) + 2] },
    textAction: '',
  })
  ...
  expect(createCardWithMove('7', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: '7',
    possible: true,
    ballActions: { 0: [ballGoal(0, balls) + 3, ballGoal(0, balls) + 1, ballGoal(0, balls)] },
    textAction: '',
  })
  expect(createCardWithMove('7-3', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: '7-3',
  ...
  expect(createCardWithMove('7-1', balls, 0, 0, initializeTeams(4, 2), cardsSample, false, null)).toEqual({
    title: '7-1',
    possible: true,
    ballActions: { 0: [ballGoal(0, balls) + 3, ballGoal(0, balls) + 1] },
    textAction: '',
  })
})
...
test('initializeTeams', () => {
  expect(initializeTeams(4, Math.floor(Math.random() * 100))).toEqual([
    [0, 2],
    [1, 3],
  ])
  expect(initializeTeams(6, 2)).toEqual([
    [0, 2, 4],
    [1, 3, 5],
  ])
  expect(initializeTeams(6, 3)).toEqual([
    [0, 3],
    [1, 4],
    [2, 5],
  ])
...
test('getPlayablePlayers, 4', () => {
  ...
  for (let i = 0; i < nPlayers; i++) {
    // In beginning only own balls playable
