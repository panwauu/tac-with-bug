<template>
  <div ref="advertPageRef" class="advertPage" :class="{ 'advertPagePortrait': showPortrait }">
    <div style="width: 100%;">
      <img
    ...
    <div style="display: flex; justify-content: center;">
      <div
        style="display: flex; flex-direction: column; align-items: center; padding: 10px; flex: 0 1 600px; max-width: 100%;"
      >
