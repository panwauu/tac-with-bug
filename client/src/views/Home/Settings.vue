<template>
  <div class="p-card settingsPage">
    <Accordion v-model:activeIndex="activeIndex">
      <AccordionTab :header="$t('Settings.ChangeUsername.header')" :disabled="!isLoggedIn">
        <SettingsUsernameUpdate @settingoperationdone="activeIndex = undefined" />
      </AccordionTab>
      <AccordionTab :header="$t('Settings.ChangeMail.header')" :disabled="!isLoggedIn">
        <SettingsMailUpdate @settingoperationdone="activeIndex = undefined" />
      </AccordionTab>
      <AccordionTab :header="$t('Settings.ChangePassword.header')" :disabled="!isLoggedIn">
        <SettingsPasswordUpdate @settingoperationdone="activeIndex = undefined" />
      </AccordionTab>
      <AccordionTab :header="$t('Settings.UploadProfilePicture.header')" :disabled="!isLoggedIn">
        <SettingsProfilePicture @settingoperationdone="activeIndex = undefined" />
      </AccordionTab>
      <AccordionTab :header="$t('Settings.DeleteProfile.header')" :disabled="!isLoggedIn">
