...
const chartData = ref({
  ...
  datasets: [
    ...
    },
    {
      ...
      labels: [
        `${i18n.global.t('Profile.DistributionGraph.4er')} ${i18n.global.t(
          'Profile.DistributionGraph.won'
        )}`,
        `${i18n.global.t('Profile.DistributionGraph.4er')} ${i18n.global.t(
          'Profile.DistributionGraph.lost'
        )}`,
        `${i18n.global.t('Profile.DistributionGraph.6er')} ${i18n.global.t(
          'Profile.DistributionGraph.won'
        )}`,
        `${i18n.global.t('Profile.DistributionGraph.6er')} ${i18n.global.t(
          'Profile.DistributionGraph.lost'
