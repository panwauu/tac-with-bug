...
test('Test sevenReconstructPath', () => {
    ...
    balls[0].state = 'valid'
    expect(sevenReconstructPath(balls, 0, ballGoal(0, balls) + 1)).toEqual([ballGoal(0, balls) - 4, ballGoal(0, balls) - 3, ballGoal(0, balls) - 2, ballGoal(0, balls) - 1, ballStart(0, balls), ballGoal(0, balls), ballGoal(0, balls) + 1])
    expect(sevenReconstructPath(balls, 0, ballStart(0, balls) + 1)).toEqual([ballGoal(0, balls) - 4, ballGoal(0, balls) - 3, ballGoal(0, balls) - 2, ballGoal(0, balls) - 1, ballStart(0, balls), ballStart(0, balls) + 1])
    expect(() => { sevenReconstructPath(balls, 0, ballStart(0, balls) + 7); }).toThrow('Could not reconstruct Path of 7')
})
