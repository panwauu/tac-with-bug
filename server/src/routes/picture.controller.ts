...
export class PictureController extends Controller {
    ...
    public async getProfilePicture(
        ...
        if (pictureRes.isErr()) { return invalidUsernameError(400, { message: pictureRes.error }) }
    ...
    public async uploadProfilePicture(
        ...
        if (request.file?.buffer === undefined) { return serverError(500, { message: 'Internal Server Error' }) }
